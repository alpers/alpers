...
- AI-Assisted Software Engineering (LLM-based workflows, agentic tooling, context engineering, AI-augmented development)
- Software Engineering (Java, Spring Framework, SQL, Python)
- Search & Distributed Data Systems (Elasticsearch, Apache Spark, Apache Kafka, Apache Cassandra, Redis)
- Data Science & Machine Learning (Python, NumPy, Pandas, Scikit-learn, PyTorch)
- Applied AI for Business Process Optimization (deep learning, predictive analytics, data-driven problem solving)
